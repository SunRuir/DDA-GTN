...
class GraphConvolution():
    ...
    def __init__(self, input_dim, output_dim, adj, name, dropout=0.6, act=tf.nn.relu):
        self.name = name
        self.vars = {}
        self.issparse = False
...
class GraphConvolutionSparse():
    ...
    def __init__(self, input_dim, output_dim, adj, features_nonzero, name, dropout=0.6, act=tf.nn.relu):
        self.name = name
        self.vars = {}
        with tf.compat.v1.variable_scope(self.name + '_vars'):
            self.vars['weights'] = weight_variable_glorot(
...
class InnerProductDecoder():
    ...
    def __init__(self, input_dim, name, num_r, dropout=0.6, act=tf.nn.sigmoid):
        self.name = name
        self.vars = {}
        self.issparse = False
        self.dropout = dropout
