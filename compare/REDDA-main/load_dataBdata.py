...
def load():
    drug_drug = pd.read_csv('./Bdataset/drug_drug_baseline.csv', header=None).values
    drug_sim = drug_drug
    ...
    protein_protein = pd.read_csv('./Bdataset/Interactions/protein_protein.csv')
    ...
    disease_disease = pd.read_csv('./Bdataset/disease_disease_baseline.csv', header=None).values
    ...
    drug_protein = pd.read_csv('./Bdataset/Associations/drug_protein.csv')
    ...
    protein_disease = pd.read_csv('./Bdataset/Associations/protein_disease.csv')
    drug_disease = pd.read_csv('./Bdataset/Associations/Bdataset.csv')
    graph_data = {
    ...
    cc = g.nodes['drug'].data['h']
    dd = g.nodes['drug'].data
    ee = g.nodes['drug']
    ff = g.nodes
