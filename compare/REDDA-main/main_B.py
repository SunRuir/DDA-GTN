...
def train():
    ...
    df = pd.read_csv('./Bdataset/{}.csv'.format(args.dataset), header=None).values
    # data 405876行3列
    ...
    random_rows = np.random.choice(data_neg.shape[0],size=18416,replace=False)
    ...
    result_file.write(f'REDDA--GPU---KFCdataset\n')
